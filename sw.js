const CACHE_NAME='lerno-v6';
const APP_FILES=['./','./index.html','./manifest.webmanifest','./assets/style.css','./assets/auth.js','./assets/app.js','./assets/icon-192.png','./assets/icon-512.png'];
