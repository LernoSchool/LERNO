const CACHE_NAME='lerno-v7-icon';
const APP_FILES=['./','./index.html','./manifest.webmanifest','./assets/style.css','./assets/auth.js','./assets/app.js','./assets/lerno-icon-180.png','./assets/lerno-icon-192.png','./assets/lerno-icon-512.png'];
